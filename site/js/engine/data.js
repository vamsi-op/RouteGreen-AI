// Sample dataset + physical constants for RouteGreen AI (ported to vanilla JS).

/**
 * Sample dataset — North-East India hilly corridor.
 * The depot (Guwahati) sits low; delivery stops climb into the Meghalaya hills.
 * Heavy cargo is destined for far / high stops so a distance-only router
 * produces a sub-optimal fuel order, letting the GA demonstrate a real saving.
 */
...
/** 2.5-ton diesel truck cargo bay: 2.0m W x 2.0m H x 4.0m D = 16.0 m^3. */
export const DEFAULT_CONTAINER = { W: 2.0, H: 2.0, D: 4.0, maxWeight: 3000 };

export const DEFAULT_FUEL_COEFFS = {
  cBase: 0.15,
 ...
 * giving an honest ~81% volume fill). Heavy units routed to far/high stops.
 */
